...
- Challenging issues in I2I problems
  - I2I problem: key challenge is to learn a joint distribution $$p(x_1,x_2)$$ of images in different domains (probabilistic modeling perspective)
  - Unsupervised I2I problem: two sets consist of images from two marginal distributions $$p(x_1),p(x_2)$$ (diff modal) $$\rightarrow$$ to finer the joint distribution
