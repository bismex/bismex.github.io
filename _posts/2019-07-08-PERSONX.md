...
- Summary
  ...
  - Evaluation: training (410 identities) and testing (856 identities, query $$\rightarrow$$ one images per camera for each identity)
- Identities
...
<br/>
<p align="center" style="color: #e01f1f; font-weight: bold;">[Market-1203에 대한 예시]</p>
