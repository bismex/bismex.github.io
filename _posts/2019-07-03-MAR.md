...
- Soft multilabel-guided discriminative embedding learning (MDL)
  - $$L_{MDL} = -\log \frac{\overline{P}}{\overline{P} + \overline{N}}$$, $$\overline{P} = \frac{1}{|\mathcal{P}|} \sum_{(i, j) \in \mathcal{P}} \exp (-\left \| f(z_i) - f(z_j) \right \|^2_2)$$, $$\overline{N} = \frac{1}{|\mathcal{N}|} \sum_{(i, j) \in \mathcal{N}} \exp (-\left \| f(z_i) - f(z_j) \right \|^2_2)$$
