...
<br/>
![picture]({{ '/assets/images/PATB02.png' | relative_url }})
{: style="width: 100%;" class="center"}
<span style="color: #e01f1f;">***Fig. 2. Deep fashion 포즈 변형 결과***</span>

<br/>
![picture]({{ '/assets/images/PATB03.png' | relative_url }})
{: style="width: 100%;" class="center"}
<span style="color: #e01f1f;">***Fig. 3. Market-1501 포즈 변형 결과***</span>

- Attention mask 시각화
  - Attention mask가 처음에는 몸통, 디테일한 포즈를 잡더니 마지막에는 배경을 잡아서 변화시킨다.

<br/>
![picture]({{ '/assets/images/PATB04.png' | relative_url }})
{: style="width: 100%;" class="center"}
<span style="color: #e01f1f;">***Fig. 4. PATB의 진행정도에 따른 attention mask 모양 변화***</span>
...
<br/>
![picture]({{ '/assets/images/PATB05.png' | relative_url }})
{: style="width: 100%;" class="center"}
<span style="color: #e01f1f;">***Fig. 5. Re-identification 적용 성능***</span>
