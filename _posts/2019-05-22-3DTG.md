...
{: style="width: 70%;" class="center"}
<span style="color: #e01f1f;">***Fig. 3. Re-ID loss에 대한 ablation studies 1***</span>
...
<br/>
![picture]({{ '/assets/images/3DTG04.png' | relative_url }})
{: style="width: 70%;" class="center"}
<span style="color: #e01f1f;">***Fig. 4. Re-ID loss에 대한 ablation studies 2***</span>
