...
- Loss function
  ...
  - Appearance generative network
    ...
    - ***Content loss***
      ...
      - Loss: $$L^{cont}_A = \left \| \Lambda(\tilde{I}_{P_s}) - \Lambda(I_{P_s}) \right \|^2_2$$
    ...
    - ***Sytle loss***
      ...
      - Eq: $$L^{sty}(I_1, I_2, S_1, S_2) = \sum^L_{l=1} \left \| \mathcal{G}( \bigotimes ) - \mathcal{G}( \bigotimes ) \right \|^2_2$$
