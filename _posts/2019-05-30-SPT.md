...
$$ = \mathbb{E}_{S_{P^*_t}} [\log D_S (S_{P^*_t})] + \mathbb{E}_{\tilde{S}_{P^*_t}} [\log (1 - D_S (\tilde{S}_{P^*_t}) ]$$
  ...
  - Appearance generation
    ...
    - ***Adversarial loss***:
      - 사용: $$I_{P_s}, \tilde{I}_{P_s}, \tilde{I}_{P_t}$$, generator, discriminator
      - $$D_A$$가 생성된 영상이 실제인지 아닌지 구분 (Source image와 생성된 target image 사이) 그리고 (source image와 생성된 source image사이) 
    - ***Pose loss***:
      - 사용: $$\tilde{I}_{P_s}, \tilde{I}_{P_t}$$, pose detector, $$P_s, P_t$$
    ...
    - ***Sytle loss***: 
      ...
      - 
    - ***Face loss***: 
      - 사용: $$I_{P_s}, \tilde{I}_{P_t}$$, $$I_{P_s}, \tilde{I}_{P_s}$$, face extraction
